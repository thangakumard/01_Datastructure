...
This is best done at creation time, to prevent accidental un-synchronized access to the set:
...
Note that the fail-fast behavior of an iterator cannot be guaranteed as it is, generally speaking,
 impossible to make any hard guarantees in the presence of un-synchronized concurrent modification.
...
public class Set02_TreeSet {
	...
	public void treesetSample() {
		TreeSet<Object> treeSet = new TreeSet<>();
	      ...
	      treeSet.add(30);
	      treeSet.add(10);
	      treeSet.add(10); // Duplicate record
	      treeSet.add(60);
	      treeSet.add(80);
