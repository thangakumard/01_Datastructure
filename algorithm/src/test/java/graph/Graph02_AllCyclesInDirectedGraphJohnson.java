...
public class Graph02_AllCyclesInDirectedGraphJohnson {
    ...
    public List<List<Vertex<Integer>>> simpleCyles(Graph<Integer> graph) {
        ...
        long startIndex = 1;
        Graph02_AllCyclesInDirectedGraphJohnson tarjan = new Graph02_AllCyclesInDirectedGraphJohnson();
        while(startIndex <= graph.getAllVertex().size()) {
            Graph<Integer> subGraph = createSubGraph(startIndex, graph);
            List<Set<Vertex<Integer>>> sccs = null;//tarjan.scc(subGraph);
   ...
   private Optional<Vertex<Integer>> leastIndexSCC(List<Set<Vertex<Integer>>> sccs, Graph<Integer> subGraph) {
    ...
    @Test
    public void test() {
    	Graph02_AllCyclesInDirectedGraphJohnson johnson = new Graph02_AllCyclesInDirectedGraphJohnson();
