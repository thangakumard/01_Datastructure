...
public class Amazon_08_Partitionlabels {

	/****
	 * https://algorithmsandme.com/partition-labels/
	 * https://leetcode.com/problems/partition-labels/
	 * 
	 * Given a string S, partition the string into maximum possible partitions 
	 * so that each letter appears in at most one part, and return a list of integers containing the size of each partition.
For example:
