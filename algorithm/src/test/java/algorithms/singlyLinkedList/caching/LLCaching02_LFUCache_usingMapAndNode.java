package algorithms.singlyLinkedList.caching;
 ...
 *
 */
public class LLCaching02_LFUCache_usingMapAndNode {
    @Test
    private void testLRU() {
        LLCaching02_LFUCache_usingMapAndNode lfuCahche = new LLCaching02_LFUCache_usingMapAndNode(3);
        System.out.println(lfuCahche.get(1));
        lfuCahche.put(1,1);
        lfuCahche.put(2,2);
        lfuCahche.put(3,3);
        lfuCahche.put(4,4);
        System.out.println(""+lfuCahche.get(4));
    }
    ...
    public LLCaching02_LFUCache_usingMapAndNode(int capacity) {
        this.min = -1;
