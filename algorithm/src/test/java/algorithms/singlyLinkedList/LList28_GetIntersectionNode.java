 ...
 * Output: null Input Explanation: From the head of A, it reads as [2,6,4]. From
 ...
 * may assume there are no cycles anywhere in the entire linked structure. Each
 * value on each linked list is in the range [1, 10^9]. Your code should
