...
- [Motivating Problems Solved](#motivating-problems-solved)
...
- [Simple Queue Pattern](#simple-queue-pattern)
- [Fan-Out Pattern](#fan-out-pattern)
- [Fan-In Pattern](#fan-in-pattern)
- [Publish-Subscribe Pattern](#publish-subscribe-pattern)

### [4. Deep Dive Topics](#deep-dive-topics)
- [1. Partitioning and Scaling](#1-partitioning-and-scaling)
  - [Why Partitioning?](#why-partitioning)
  - [Solution: Horizontal Partitioning](#solution-horizontal-partitioning)
  - [Partition Key Selection Trade-offs](#partition-key-selection-trade-offs)
  - [Auto-Scaling Partitions](#auto-scaling-partitions)
- [2. Back Pressure Handling](#2-back-pressure-handling)
  - [The Problem](#the-problem)
  - [Solutions (in order of preference)](#solutions-in-order-of-preference)
  - [What NOT to do](#what-not-to-do)
- [3. Handling Failures: Poisoned Messages](#3-handling-failures-poisoned-messages)
  - [The Scenario](#the-scenario)
  - [Solution: Dead Letter Queue (DLQ)](#solution-dead-letter-queue-dlq)
  - [DLQ Handling](#dlq-handling)
  - [Configuration](#configuration)
- [4. Durability and Persistence](#4-durability-and-persistence)
  - [Failure Scenarios & Solutions](#failure-scenarios--solutions)
  - [Persistence Strategies](#persistence-strategies)
  - [Replayability (Kafka specific advantage)](#replayability-kafka-specific-advantage)
- [5. Message Ordering Guarantees](#5-message-ordering-guarantees)
  - [Types of Ordering](#types-of-ordering)
  - [Use Cases](#use-cases)
  - [Interview Tip (Senior Level)](#interview-tip-senior-level)
- [6. Latency Considerations](#6-latency-considerations)
  - [End-to-End Latency Components](#end-to-end-latency-components)
  - [Optimization Techniques](#optimization-techniques)
- [7. Consumer Groups and Offset Management](#7-consumer-groups-and-offset-management)
  - [Consumer Groups Explained](#consumer-groups-explained)
  - [Offset Management Strategies](#offset-management-strategies)
  - [Consumer Lag Monitoring](#consumer-lag-monitoring)
- [8. Exactly-Once vs At-Least-Once Trade-offs](#8-exactly-once-vs-at-least-once-trade-offs)
...
- [Apache Kafka](#apache-kafka)
  ...
  - [Configuration Tuning (Interview Focus)](#configuration-tuning-interview-focus)
  - [When to Use](#when-to-use)
- [AWS SQS (Simple Queue Service)](#aws-sqs-simple-queue-service)
  - [Architecture](#architecture-1)
  - [Strengths](#strengths-1)
  - [Weaknesses](#weaknesses-1)
  - [Standard Queue (Default)](#standard-queue-default)
  - [FIFO Queue](#fifo-queue)
  - [Configuration (Interview)](#configuration-interview)
  - [When to Use](#when-to-use-1)
- [RabbitMQ](#rabbitmq)
  - [Architecture](#architecture-2)
  - [Strengths](#strengths-2)
  - [Weaknesses](#weaknesses-2)
  - [Routing Patterns (Unique)](#routing-patterns-unique)
  - [When to Use](#when-to-use-2)
- [Technology Decision Matrix](#technology-decision-matrix)
- [Interview Recommendation](#interview-recommendation)

### [6. Implementation Patterns](#implementation-patterns)
- [Pattern 1: Simple Async Task Processing](#pattern-1-simple-async-task-processing)
- [Pattern 2: Event-Driven Microservices](#pattern-2-event-driven-microservices)
- [Pattern 3: Request-Reply with Correlation ID](#pattern-3-request-reply-with-correlation-id)

### [7. Interview Strategy by Seniority](#interview-strategy-by-seniority)
- [Mid-Level Engineer](#mid-level-engineer)
  - [Expected Knowledge](#expected-knowledge)
  - [Interview Approach](#interview-approach)
  - [Things to Mention](#things-to-mention)
- [Senior Engineer](#senior-engineer)
  - [Expected Knowledge](#expected-knowledge-1)
  - [Interview Approach](#interview-approach-1)
  - [Things to Mention](#things-to-mention-1)
- [Staff/Principal Engineer](#staffprincipal-engineer)
  - [Expected Knowledge](#expected-knowledge-2)
  - [Interview Approach](#interview-approach-2)
  - [Things to Mention](#things-to-mention-2)

### [8. Common Pitfalls](#common-pitfalls)
- [Pitfall 1: Using Queues for Synchronous Work](#pitfall-1-using-queues-for-synchronous-work)
- [Pitfall 2: Ignoring Partition Key Selection](#pitfall-2-ignoring-partition-key-selection)
- [Pitfall 3: Not Handling Backpressure](#pitfall-3-not-handling-backpressure)
- [Pitfall 4: Fire-and-Forget Without Idempotency](#pitfall-4-fire-and-forget-without-idempotency)
- [Pitfall 5: Choosing Wrong Technology](#pitfall-5-choosing-wrong-technology)
- [Pitfall 6: Missing Dead Letter Queue Handling](#pitfall-6-missing-dead-letter-queue-handling)
- [Pitfall 7: Insufficient Monitoring](#pitfall-7-insufficient-monitoring)

### [9. Putting It All Together: Complete Example](#putting-it-all-together-complete-example)
- [Scenario](#scenario)
- [Complete System Design](#complete-system-design)

### [10. Final Interview Checklist](#final-interview-checklist)
- [Before Whiteboarding](#before-whiteboarding)
- [When Introducing Queue](#when-introducing-queue)
- [When Asked to Scale](#when-asked-to-scale)
- [When Asked About Failures](#when-asked-about-failures)
- [When Asked to Choose Technology](#when-asked-to-choose-technology)

### [11. Key Takeaways](#key-takeaways)

### [12. Resources for Deeper Learning](#resources-for-deeper-learning)
- [Kafka](#kafka)
- [SQS](#sqs)
- [RabbitMQ](#rabbitmq-1)
- [General](#general)
